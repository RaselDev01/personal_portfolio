...
//                 <h4 className="text-[17px] font-medium">{item.name}</h4>
//                 <h4 className="text-[15px] font-medium">{item.level}</h4>
//               </div>
//               <div className="w-full bg-gray-200 rounded-full h-2">
//                 <div
//                   className="bg-sunC h-2 rounded-full transition-all duration-1000"
